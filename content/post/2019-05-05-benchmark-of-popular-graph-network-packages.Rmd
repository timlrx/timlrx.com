...
<span style="color:blue">13/12/2019 Edit: An astute reader pointed out that for the pagerank algorithm, networkit uses L2 as norm as a stopping criteria while other packages use the L1 norm. This means that it is doing fewer iterations than the other products and the speed is somewhat artificial</span>
