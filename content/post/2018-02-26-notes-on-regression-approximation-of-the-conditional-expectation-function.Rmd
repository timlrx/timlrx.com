...
- [Part 1 - OLS by way of minimising the sum of square errors](/2017/08/16/notes-on-regression-ols/)

- [Part 2 - Projection and Orthogonality](/2017/08/23/notes-on-regression-projection/)

- [Part 3 - Method of Moments](/2017/08/31/notes-on-regression-method-of-moments/)

- [Part 4 - Maximum Likelihood](/2017/09/21/notes-on-regression-maximum-likelihood/)

- [Part 5 - Singular Vector Decomposition](/2017/10/21/notes-on-regression-singular-vector-decomposition/)
...
![Regression as the best linear approximation to the CEF](/img/CEF_regression.png)
