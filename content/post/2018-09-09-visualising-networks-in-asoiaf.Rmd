...
author: Timothy Lin
date: '2018-09-09'
slug: visualising-networks-in-asoiaf
categories: []
...
```{r circular, fig.width = 12, fig.height = 8}
...
```{r book1, fig.width = 12, fig.height = 8}
plot_graph(all_graphs[[1]])
```

```{r book2,  fig.width = 12, fig.height = 8}
plot_graph(all_graphs[[2]])
```

```{r book3, fig.width = 12, fig.height = 8}
plot_graph(all_graphs[[3]])
```

```{r book4, fig.width = 12, fig.height = 8}
plot_graph(all_graphs[[4]])
```

```{r book5, fig.width = 12, fig.height = 8}
